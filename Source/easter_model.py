...
def Easter2(predict_mode = False):
    ...
    if predict_mode == True:
        # compiling model
        model = tensorflow.keras.models.Model(inputs = input_data, outputs= y_pred)
        return model
...
def train():
    ...
    model = Easter2(predict_mode=False)
    ...
    model.save(r'C:\Users\tiend\OneDrive\Documents\ASU MSBA 2024\CIS515 AI and Data Analytics Strategy\Final Project\Easter2\weights\trained_model.keras')
    model.save_weights(r'C:\Users\tiend\OneDrive\Documents\ASU MSBA 2024\CIS515 AI and Data Analytics Strategy\Final Project\Easter2\weights\saved_weights.weights.h5', overwrite=True)